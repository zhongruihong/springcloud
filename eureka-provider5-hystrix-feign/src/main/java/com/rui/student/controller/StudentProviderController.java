...
public class StudentProviderController {
    ...
    public Map<String,Object> getInfo() throws InterruptedException{
		System.err.println("provider-hystrix&feign-controller-1005");
        Thread.sleep(1000);
	...
	public boolean save(@RequestBody Student s) {
		try {
			System.err.println("provider-hystrix&feign-controller-1005-getInfo");
	...
	public List<Student> list() throws InterruptedException {
		System.err.println("provider-hystrix&feign-controller-1005-list");
		//Thread.sleep(1000);
	...
	public Student get(@PathVariable("id") Integer id) {
		System.err.println("provider-hystrix&feign-controller-1005-get/id");
	...
	public boolean delete(@PathVariable("id") Integer id) {
		try {
			System.err.println("provider-hystrix&feign-controller-1005-delete/id");
